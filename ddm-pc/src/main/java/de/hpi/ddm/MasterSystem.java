...
public class MasterSystem {
    ...
    public static void start3() {
        ...
        ActorSystem system = ActorSystem.create(c.getActorSystemName(), config);
        ActorRef collector = system.actorOf(Collector.props(), Collector.DEFAULT_NAME);
        start2(c, system, collector);
    }

    public static void start2(final Configuration c, final ActorSystem system, ActorRef collector) {
